...
05/02/22 addtiion: t-tests! DELETE B/C CONFUSING??
Not results below.
```{r}
?t.test
library(dplyr)
...
#results
NamesEnergy <- as.vector(c("Energy density mean hatch", "Energy density mean wild", "SD hatch", "SD wild", "Sample size hatch", "Sample size wild"))
NamesLipids <- c("Lipid density mean hatch", "Lipid density mean wild", "SD hatch", "SD wild", "Sample size hatch", "Sample size wild" )
ResultsEnergy <- c(estimate_ED[1,],estimate_ED[2,], sd_ED_h, sd_ED_w, ss_hatch, ss_wild)
ResultsLipids <- c(estimate_lipid[1,],estimate_lipid[2,], sd_lipid_hatch, sd_lipid_wild, ss_hatch, ss_wild)
