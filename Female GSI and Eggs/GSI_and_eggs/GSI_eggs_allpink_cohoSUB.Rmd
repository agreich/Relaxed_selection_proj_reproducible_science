...
LOAD DATAS
```{r}
p1 <- read.csv("/Users/alexandrareich/Desktop/THESIS TIME!/Field Data Year 2/Eggs Revisted Yr1/FemalePinkGSIotodataadd1_without_gaps copy.csv")
...
p2_GSI_clean_date_alt <- read.csv("p2.GSI.clean_altdate.csv")
...
```{r}
c.GSI.dat <-read.csv("/Users/alexandrareich/Desktop/THESIS TIME!/Field Data Year 2/Eggs Revisted Yr1/MASTERFemaleCohoQCwitheggs_copy.csv")
...
Quick aside to create a csv for my GSI
```{r}
...
EGGS
(ok how to go about this...) There's some complex data wrangling and I need to make sure I copy it over correctly. And the mixed effect model as well.
(might be easiest to start backwards)



P1 Eggs
```{r}
p1.all.eggs <- read.csv("/Users/alexandrareich/Desktop/THESIS TIME!/Field Data Year 2/Eggs Revisted Yr1/P1.egg.diameters.csv")
names(p1.all.eggs)
head(p1.all.eggs)

#the other pink even data
p1.other.data<- read.csv("/Users/alexandrareich/Desktop/THESIS TIME!/Field Data Year 2/Eggs Revisted Yr1/FemalePinkGSIotodataadd1_without_gaps copy.csv")
...
BIC(fit.p2.B.ml, fit.p2.B3.ml, fit.p2.B4.ml, fit.p2.alpha, fit.p2.B5.ml, fir.p2.Julian)
...
RUSSIA AMMENDMENTS
FUCKED UP STUFF, dont use this block
```{r}
