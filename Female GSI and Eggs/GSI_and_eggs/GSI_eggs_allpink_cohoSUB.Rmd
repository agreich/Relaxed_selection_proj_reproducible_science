...
#pink odd (p2)###########################
p2.all.eggs <- read.csv("/Users/alexandrareich/Desktop/THESIS TIME!/Compilation of GITHUB project code/Relaxed_selection_proj_reproducible_science/DATA/Results.p2.ImageJ.eggs.csv")
library(tidyverse)
...
##
estimate_coho_ttest <-  p2.GSI.t.test$estimate
sd_coho_GSI_h <- sd(GSI.for.ttest.hatch$GSI.1)
sd_coho_GSI_w <- sd(GSI.for.ttest.wild$GSI.1)
ss_hatch_coho_GSI <- length(GSI.for.ttest.hatch$GSI.1)
ss_wild_coho_GSI <- length(GSI.for.ttest.wild$GSI.1)
t_GSI_coho <- p2.GSI.t.test$statistic
p_GSI_coho <- p2.GSI.t.test$p.value
df_GSI_coho <- p2.GSI.t.test$parameter
